        ...
        >
          <div>
            ...
            >
              ...
              <p className={inter.className}>
                Find in-depth information about 0xPass features and API.
              </p>
            </a>
          </div>
          <div>
            <a
              ...
              rel="noopener noreferrer"
            >
              <h2 className={inter.className}>Get Started</h2>
              <p className={inter.className}>
                Get started using a super powered wallet today
              </p>
              <p className={inter.className}>
                Connect web2 and web3 login methods, integrate with embedded
                wallet providers, and efficiently manage users, all in one
                place.
              </p>
            </a>
          </div>
